...
ITERATION_PATH_STEP_FACTOR = 0.1

START_POSITION = (0, 1, 0)
TARGET_POINT = (1, -1, 2)

ORIGIN_ITERATION_STEP_FACTOR = 0.5
ORIGIN_SPEED_REDUCTION_SHIFT = 0.5
ORIGIN_LINEAR_VELOCITY_PROPORTIONAL_FACTOR = 0.5
ORIGIN_ANGULAR_VELOCITY_PROPORTIONAL_FACTOR = 2

ITERATION_STEP_FACTOR = 0.5
SPEED_REDUCTION_SHIFT = 0.5
LINEAR_VELOCITY_PROPORTIONAL_FACTOR = 1
ANGULAR_VELOCITY_PROPORTIONAL_FACTOR = 3
